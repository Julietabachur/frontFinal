...
const NewProduct = ({
  ...
  const handleAddCharacteristic = () => {
    if (newFeature && productToEdit !== null) {
      const existingFeatureIndex = productData.features.findIndex(
        (feature) => feature.charName === newFeature
      );
      ...
      if (existingFeatureIndex !== -1) {
        ...
        setProductData((prevState) => ({
          ...
          features: [
            ...
            {
              id: nanoid(),
              charIcon: selectedFeature.charIcon,
              charName: newFeature,
              charValue: [newFeatureValue],
            },
          ],
        }));
      }
  ...
  const handleRemoveCharacteristic = (id) => {
    ...
    const indexToRemove = productData.features.findIndex(
    ...
    if (indexToRemove !== -1) {
      ...
      const updatedFeatures = [
        ...productData.features.slice(0, indexToRemove),
        ...productData.features.slice(indexToRemove + 1),
      ];
